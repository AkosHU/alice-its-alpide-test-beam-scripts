...
void compareOneHistogram(string files, string hist, string sectorStr, bool IthrVcasn, double IthrVcasnValue, bool BB=false, bool irr=true, bool chip=false, bool rate=false);
